...
char SentidoActualIzq;
char SentidoActualDer;
...
void main(void) {
    ...
    TRISBbits.TRISB5 = 0;               // Pin 14 como salida - LED 1
            ...
            for(i = 0; i < contR; i++){
                switch (smsR[i]){
                    ...
                    case 'a':
                        ...
                        break;
                    default:
                        EnviarCadena("Error: ",7);
                        EnviarCaracter(smsR[i]);
                        EnviarCadena("\r\n",2);
                        break;
                }
            }
...
void Velocidad(void){
    ...
    var = (smsR[i+2]-48)*1000 + (smsR[i+3]-48)*100 + (smsR[i+4]-48)*10 + smsR[i+5] - 48;
            ...
            switch(PasosESP){            
                ...
                case 3:
                    if(smsR[0]=='O' && smsR[1]=='K'){
                        smsR[0] = '@';
                        Revision = 0;
                        EnviarCadena("AT+CWJAP_CUR=\"Megaproyecto\",\"ABC1234567\"\r\n",42);  //Conectarse a la red
                        PasosESP++;
                    }
                    break;
                ...
                case 5:
                    if(smsR[0]=='O' && smsR[1]=='K'){
                        smsR[0] = '@';
                        Revision = 0;
                        EnviarCadena("AT+CIPSTART=\"TCP\",\"192.168.1.2\",5400\r\n",38);      //Iniciar cliente TCP
                        PasosESP++;
                    }
                    break;
                case 6:
